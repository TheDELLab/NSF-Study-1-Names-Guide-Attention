...
#load audacity data
```{r}
# Read the 001 participant data file
word_labels <- read_csv("raw_data_exports/001_audacity_lables.csv", show_col_types = FALSE)
...
print(word_labels)
#write.csv(word_labels, "clean_data_exports/001_word_labels.csv")
...
#load datavyu data
```{r}
exported_datavyu <- read.csv("raw_data_exports/001_exported_datavyu_lables.csv")
...
write.csv(datavyu_export, "clean_data_exports/001_gaze_event_labels.csv")
```
...
# Read the CSV files
gaze_event_labels <- read.csv("clean_data_exports/001_gaze_event_labels.csv")
word_labels <- read.csv("clean_data_exports/001_word_labels.csv")
...
write.csv(gaze_event_labels, "clean_data_exports/001_gaze_word_merged_labels.csv")
