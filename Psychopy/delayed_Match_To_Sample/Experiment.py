...
# open a window
win = visual.Window(units='pix', fullscr=True, color='white', monitor='testMonitor') 
# info screen
...
if control_key[0] == 'space':
    ...
    for trial, audio in zip(trial_range, audio):
        ...
        number = visual.TextStim(win, text=cond.loc[trial, 'Target'], color='black', height=350, pos=(0, 0) )
        ...
        if cond.loc[trial,'Location'] == 'left':
            ...
            right_number = visual.TextStim(win, text=cond.loc[trial, 'Foil'], color='black', height=350, pos=(500, 0))
        else:
            left_number = visual.TextStim(win, text=cond.loc[trial, 'Foil'], color='black', height=350, pos=(-500, 0))
            right_number = visual.TextStim(win, text=cond.loc[trial, 'Target'], color='black', height=350, pos=(500, 0))
