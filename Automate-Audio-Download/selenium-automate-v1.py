...
for NUMBER_NAME in condition_1:
    ...
    driver.find_element(By.XPATH, '''/html/body/div[2]/div[2]/div/mat-dialog-container/app-pw-voices/mat-dialog-content/mat-selection-list/mat-list-option[9]/div/div[2]/div/div[2]/div''').click()
